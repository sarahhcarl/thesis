...
\@writefile{lof}{\contentsline {figure}{\numberline {2.4}{\ignorespaces Caption.\relax }}{60}{figure.caption.21}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {2.6}{\ignorespaces Example of problem addressed by description logics. (A) The concept Human is more specific than the concept Mammal (all humans are mammals), which can be represented as embedded sets. (B) Same logic captured, representing the concepts as nodes and the relation as edge. The mathematical meaning of (A) (sets of instances) is more accurate than the meaning of (B), yet both representation can exist in practice, in particular in biology.\relax }}{66}{figure.caption.23}}
\@writefile{lof}{\contentsline {figure}{\numberline {2.7}{\ignorespaces Example of problem addressed by description logics. (A) The concept Human is more specific than the concept Mammal (all humans are mammals), which can be represented as embedded sets. (B) Same logic captured, representing the concepts as nodes and the relation as edge. The mathematical meaning of (A) (sets of instances) is more accurate than the meaning of (B), yet both representation can exist in practice, in particular in biology.\relax }}{68}{figure.caption.24}}
\@writefile{lof}{\contentsline {figure}{\numberline {2.8}{\ignorespaces Description logics core entities: (A) Concepts and Individuals: A concept or class is a set containing some individuals. On the example shown, Human is a concept, John and Mary are both distinct individuals. (B) Roles and Individuals: Role are linking two individuals. In the example, John and Mary are still individuals linked by the role "knows", specifying their relationship.\relax }}{71}{figure.caption.25}}
...
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Intersection ($ \sqcap $)}\\}{74}{figure.caption.27}}
...
\@writefile{toc}{\contentsline {subparagraph}{Role assertion\\}{72}{subsubsection.2.3.3.2}}
