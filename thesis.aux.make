...
\@writefile{lof}{\contentsline {figure}{\numberline {1.6}{\ignorespaces Drug repositioning using gene expression. (A) Example of result obtained from a gene expression experiment. Some of the probed genes are up-regulated (green), some of them down-regulated (red). (B) and (C) The gene expression data from the Connectivity Map provides a signature which can relate drugs on their functional aspect. For instance drug X and Y are considered similar because they share a significant amount of genes up and down related. (D) An analogue reasoning can be made with the relation drug-disease: disease signature can be treated by drugs with an anti-correlating signature.\relax }}{29}{figure.caption.10}}
\@writefile{lof}{\contentsline {figure}{\numberline {1.7}{\ignorespaces Drug repositioning using protein structure and binding site. The 3D structure of proteins and their respective binding sites can be compared using a scoring function. On this basis, it is assumed that similar binding sites can bind the same ligand. For instance, knowing that protein X has a similar binding site to the one in protein Y, and that molecule Z binds to protein X, one can forward the hypothesis stating that molecule Z should bind to protein Y too. Illustrations from the Protein Data Bank.\relax }}{32}{figure.caption.11}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {3.15}{\ignorespaces Control pairwise comparison of MoAs similarities. Therapeutic indications are represented by ATC categories which are the colours on the side. One ATC level is considered on this graph, just as Figure \ref  {fig3-12}. Drugs are randomly sorted (yet symmetrically). No visual pattern is observable in this case, as opposed to what is seen on Figures \ref  {fig3-12}, \ref  {fig3-13} and \ref  {fig3-14}.\relax }}{124}{figure.caption.50}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {3.2}{\ignorespaces Regulatory pattern. Equivalent definitions for the concept \emph  {Anti-blood coagulation agent}. The concept is asserted as equivalent to either of the boxed expressions. A reasoner can understand such definition and classify drugs accordingly.\relax }}{98}{figure.caption.37}}
\@writefile{lof}{\contentsline {figure}{\numberline {3.3}{\ignorespaces Example of regulatory pattern. Equivalent definitions for the concept \emph  {Pro-blood coagulation agent}. The concept is asserted as equivalent to either of the boxed expressions. A reasoner can understand such definition and classify drugs accordingly.\relax }}{98}{figure.caption.38}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {4.7}{\ignorespaces Kernel density distribution of the functional similarity values for drugs sharing an indication. All ATC categories have been considered. Each curve represent an ATC resolution level, as indicated on the legend. Conceptual explanation of resolution levels is available on Figure \ref  {fig4-3}. Solid vertical lines are the corresponding means. This graph shows that with an increasingly specific indication (increasing resolution) the average functional similarity values increase too. See Table \ref  {tablespecind} for values.\relax }}{143}{figure.caption.58}}
...
\@writefile{lot}{\contentsline {table}{\numberline {4.3}{\ignorespaces High level association between therapeutic groups and shared pharmacology. See Figure \ref  {fig4-10} for source network.\relax }}{152}{table.caption.64}}
\@writefile{lot}{\contentsline {table}{\numberline {4.4}{\ignorespaces Drug repositioning hypotheses related to hypertension (ATC code C02). The symbol " refers to the value of the previous cell.\relax }}{157}{table.caption.67}}
\@writefile{lot}{\contentsline {table}{\numberline {4.5}{\ignorespaces Drug repositioning hypotheses related calcium channel blockers (ATC code C08). The symbol " refers to the value of the previous cell.\relax }}{160}{table.caption.70}}
\@writefile{lot}{\contentsline {table}{\numberline {4.6}{\ignorespaces Drug repositioning hypotheses related \emph  {Beat-blocking agents} (ATC code C07). The symbol " refers to the value of the previous cell.\relax }}{162}{table.caption.72}}
\@writefile{lot}{\contentsline {table}{\numberline {4.7}{\ignorespaces Actions and number of drugs classified as \emph  {Pro-alpha2-adrenergic receptor activity agent} (FTC\_P0004938).\relax }}{164}{table.caption.74}}
\@writefile{lot}{\contentsline {table}{\numberline {4.8}{\ignorespaces Drug repositioning hypotheses related to \emph  {Diuretics} (ATC code C03). The symbol " refers to the value of the previous cell.\relax }}{165}{table.caption.75}}
\@writefile{lot}{\contentsline {table}{\numberline {4.9}{\ignorespaces Drug repositioning hypotheses related to \emph  {peripheral vasodilators} (ATC code C04). The symbol " refers to the value of the previous cell.\relax }}{170}{table.caption.78}}
\@writefile{toc}{\contentsline {chapter}{Bibliography}{186}{section.5.4}}
...
\@writefile{toc}{\contentsline {chapter}{\numberline {5}Outlook and future work}{181}{chapter.5}}
\@writefile{toc}{\contentsline {chapter}{\numberline {A}Glossary}{187}{appendix.A}}
\@writefile{toc}{\contentsline {chapter}{\numberline {B}Abbreviations}{189}{appendix.B}}
\@writefile{toc}{\contentsline {chapter}{\numberline {C}Peer-reviewed publications}{191}{appendix.C}}
\@writefile{toc}{\contentsline {chapter}{\numberline {D}Side-projects}{193}{appendix.D}}
...
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Aldosterone receptor antagonists}\\}{169}{figure.caption.77}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Angiotensin II receptor antagonists}\\}{168}{figure.caption.77}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Angiotensin-converting enzyme (ACE) inhibitors}\\}{167}{figure.caption.77}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Assertional axioms (ABox)}\\}{70}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Concepts}\\}{68}{subsubsection.2.3.3.1}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Existential Restriction ($ \exists $)}\\}{73}{figure.caption.27}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Intersection ($ \sqcap $)}\\}{72}{figure.caption.27}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Named Individuals}\\}{68}{subsubsection.2.3.3.1}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Relational axioms (RBox)}\\}{72}{figure.caption.26}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Renin inhibitors}\\}{168}{figure.caption.77}}
...
\@writefile{toc}{\contentsline {section}{\numberline {2.1}Introduction}{52}{section.2.1}}
\@writefile{toc}{\contentsline {section}{\numberline {2.2}Biomedical knowledge}{53}{section.2.2}}
\@writefile{toc}{\contentsline {section}{\numberline {2.3}Description logics for biomedical knowledge representation}{63}{section.2.3}}
\@writefile{toc}{\contentsline {section}{\numberline {2.4}Implementation with life-science information}{79}{section.2.4}}
\@writefile{toc}{\contentsline {section}{\numberline {2.5}Summary}{87}{section.2.5}}
...
\@writefile{toc}{\contentsline {section}{\numberline {4.4}Summary}{175}{section.4.4}}
\@writefile{toc}{\contentsline {section}{\numberline {4.5}Methods}{177}{section.4.5}}
\@writefile{toc}{\contentsline {section}{\numberline {5.1}Work performed in the context of the drug discovery process}{182}{section.5.1}}
\@writefile{toc}{\contentsline {section}{\numberline {5.2}Comparison against functional genomics}{183}{section.5.2}}
\@writefile{toc}{\contentsline {section}{\numberline {5.3}Biomedical knowledge: towards a simpler representation}{184}{section.5.3}}
\@writefile{toc}{\contentsline {section}{\numberline {5.4}Off-label uses and clinical drug repositioning}{185}{section.5.4}}
\@writefile{toc}{\contentsline {subparagraph}{Concept assertion\\}{70}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {subparagraph}{Concept equivalence ($ \equiv $)\\}{72}{figure.caption.26}}
\@writefile{toc}{\contentsline {subparagraph}{Concept inclusion ($ \sqsubseteq $)\\}{71}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {subparagraph}{Role assertion\\}{70}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {subparagraph}{Role inclusion ($ \sqsubseteq $)\\}{72}{figure.caption.26}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.2}Gene expression and functional genomics-based approaches}{28}{subsection.1.3.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.3}Protein structure and molecular docking-based approaches}{31}{subsection.1.3.3}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.4}Phenotype and side-effect-based approaches}{34}{subsection.1.3.4}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.5}Genetic variation-based approaches}{36}{subsection.1.3.5}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.6}Disease network-based approaches}{38}{subsection.1.3.6}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.7}Machine learning and concepts combination approaches}{40}{subsection.1.3.7}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.8}Summary}{42}{subsection.1.3.8}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.4.1}Rationale}{46}{subsection.1.4.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {1.4.2}Towards the specification, implementation and analysis}{48}{subsection.1.4.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.2.1}Contemporary formalism in biomedical sciences}{53}{subsection.2.2.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.2.2}Requirements for biomedical knowledge formalisation}{59}{subsection.2.2.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.3.1}Problems addressed by description logics}{63}{subsection.2.3.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.3.2}Expressivity and complexity}{65}{subsection.2.3.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.3.3}DLs' components and relation to life sciences}{67}{subsection.2.3.3}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.3.4}Reasoning services}{76}{subsection.2.3.4}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.3.5}The Web Ontology Language 2 (OWL2)}{78}{subsection.2.3.5}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.4.1}Integration with biomedical ontologies}{79}{subsection.2.4.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.4.2}Integration with databases}{84}{subsection.2.4.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.4.3}Brain library - implementing programmatic solutions}{85}{subsection.2.4.3}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {4.2.2}Dissimilar structures have dissimilar functions}{134}{subsection.4.2.2}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {4.3.2}Drug repositioning for hypertension and the cardiovascular system}{153}{subsection.4.3.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.3.3}Repositioning for Alzheimer's disease}{172}{subsection.4.3.3}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.5.1}Structural fingerprints calculation}{177}{subsection.4.5.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.5.2}Structural similarity between drugs}{177}{subsection.4.5.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.5.3}Agreement between fingerprinting methodologies}{178}{subsection.4.5.3}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.5.4}Kernel density plots}{178}{subsection.4.5.4}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.5.5}Web application related to drug repositioning hypotheses}{179}{subsection.4.5.5}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.5.6}Filtering of drug repositioning hypotheses}{180}{subsection.4.5.6}}
\@writefile{toc}{\contentsline {subsection}{\numberline {4.5.7}Filtering of relationships between therapeutic areas}{180}{subsection.4.5.7}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {1.4.2.1}Chapter 2 - Description logics and biomedical knowledge (Specification)}{49}{subsubsection.1.4.2.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {1.4.2.2}Chapter 3 - The Functional Therapeutic Chemical Classification System (Implementation)}{49}{subsubsection.1.4.2.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {1.4.2.3}Chapter 4 - Systematic drug repositioning analysis}{50}{subsubsection.1.4.2.3}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {1.4.2.4}Chapter 5 - Outlook and future work}{50}{subsubsection.1.4.2.4}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.1.1}Formalism varies among natural sciences}{53}{subsubsection.2.2.1.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.1.2}Organisms as complex machines}{56}{subsubsection.2.2.1.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.1}Mathematical framework}{59}{subsubsection.2.2.2.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.2}Definitions}{60}{subsubsection.2.2.2.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.3}Hierarchies and abstraction}{60}{subsubsection.2.2.2.3}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.4}Distributed and scalable}{61}{subsubsection.2.2.2.4}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.5}Molecular dynamism}{62}{subsubsection.2.2.2.5}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.3.3.1}Description logics entities}{68}{subsubsection.2.3.3.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.3.3.2}Axioms}{70}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.3.3.3}Constructors}{72}{subsubsection.2.3.3.3}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.4.1.1}Open Biomedical Ontologies (OBO)}{79}{subsubsection.2.4.1.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.4.1.2}Approximations and assumptions}{81}{subsubsection.2.4.1.2}}
...
\@writefile{toc}{\contentsline {subsubsection}{\numberline {4.3.2.1}Antihypertensives}{155}{subsubsection.4.3.2.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {4.3.2.2}Calcium channel blockers}{159}{subsubsection.4.3.2.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {4.3.2.3}Adrenergic receptor antagonists}{161}{subsubsection.4.3.2.3}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {4.3.2.4}Alpha-2 agonists}{163}{subsubsection.4.3.2.4}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {4.3.2.5}Diuretics}{164}{subsubsection.4.3.2.5}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {4.3.2.6}Renin-angiotensin system}{166}{subsubsection.4.3.2.6}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {4.3.2.7}Peripheral vasodilators}{169}{subsubsection.4.3.2.7}}
