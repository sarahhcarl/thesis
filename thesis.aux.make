...
\@writefile{lof}{\contentsline {figure}{\numberline {3.15}{\ignorespaces Control pairwise comparison of MoAs similarities. Therapeutic indications are represented by ATC categories which are the colours on the side. One ATC level is considered on this graph, just as picture \ref  {fig3-12}. Drugs are randomly sorted (yet symmetrically). No visual pattern is observable in this case, as opposed to what is seen on figures \ref  {fig3-12}, \ref  {fig3-13} and \ref  {fig3-14}.\relax }}{126}{figure.caption.50}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {3.2}{\ignorespaces Regulatory pattern. Equivalent definitions for the concept “Anti-blood coagulation agent”. The concept is asserted as equivalent to either of the boxed expressions. A reasoner can understand such definition and classify drugs accordingly.\relax }}{100}{figure.caption.37}}
\@writefile{lof}{\contentsline {figure}{\numberline {3.3}{\ignorespaces Example of regulatory pattern. Equivalent definitions for the concept “Pro-blood coagulation agent”. The concept is asserted as equivalent to either of the boxed expressions. A reasoner can understand such definition and classify drugs accordingly.\relax }}{100}{figure.caption.38}}
