...
\@writefile{lof}{\contentsline {figure}{\numberline {1.4}{\ignorespaces Conceptual map of the relationship between the different biomedical concepts. Relation related to the drug and its action are in orange, diseases in grey and biological concepts are in blue. Computational drug repositioning methods are based on either one or a series of such concepts in order to forward new indications for a drug, ultimate goal (red edge).\relax }}{27}{figure.caption.8}}
\@writefile{lof}{\contentsline {figure}{\numberline {1.5}{\ignorespaces Drug repositioning using the chemical structure. Compounds with similar structures have similar biological activities (similarity principle). Drug A shares some similarity with molecule B, indicated by the blue areas. This observation leads to the conclusion that molecule A could be active on the canonical target of molecule B, and indicated accordingly. See \cite  {keiser2009predicting} for full details on example. Structures obtained from the ChemSpider database.\relax }}{28}{figure.caption.9}}
\@writefile{lof}{\contentsline {figure}{\numberline {1.6}{\ignorespaces Drug repositioning using gene expression. (A) Example of result obtained from a gene expression experiment. Some of the probed genes are up-regulated (green), some of them down-regulated (red). (B) and (C) The gene expression data from the Connectivity Map provides a signature which can relate drugs on their functional aspect. For instance drug X and Y are considered similar because they share a significant amount of genes up and down related. (D) An analogue reasoning can be made with the relation drug-disease: disease signature can be treated by drugs with an anti-correlating signature.\relax }}{30}{figure.caption.10}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {5.1}{\ignorespaces Time line of the drug discovery process. My thesis work focused on the Discovery/Synthesis section of the graph.\relax }}{187}{figure.caption.82}}
...
\@writefile{lot}{\contentsline {table}{\numberline {4.10}{\ignorespaces FTC categories describing some of the modes of action that could impact Alzheimer's disease (letters on figure). The categories have been manually picked on the basis that they could directly affect the dementia. Drugs classified in these FTC categories further manually grouped based on their MoAs similarities (numbers on Figure).\relax }}{177}{table.caption.80}}
\@writefile{lot}{\contentsline {table}{\numberline {4.1}{\ignorespaces Pearson's Correlation values between various fingerprinting methodologies. "Mean corr." stands for the mean value of the correlation coefficients. "Ext." stand for Extended fingerprinter, "Hybrid." for Hybridization. "Range" describes the interquartile range (Qu.3 - Qu.1), based on the similarity values.\relax }}{136}{table.4.1}}
\@writefile{lot}{\contentsline {table}{\numberline {4.2}{\ignorespaces Evolution of the specificity of indication with the ATC levels. Increasingly similar indications have increasingly similar functional and structural values. The functional and structural similarity values are not evolving when increasingly different indications are considered.\relax }}{144}{table.4.2}}
\@writefile{lot}{\contentsline {table}{\numberline {4.3}{\ignorespaces High level association between therapeutic groups and shared pharmacology. See Figure \ref  {fig4-10} for source network.\relax }}{155}{table.caption.64}}
\@writefile{lot}{\contentsline {table}{\numberline {4.4}{\ignorespaces Drug repositioning hypotheses related to hypertension (ATC code C02). The symbol " refers to the value of the previous cell.\relax }}{160}{table.caption.67}}
\@writefile{lot}{\contentsline {table}{\numberline {4.5}{\ignorespaces Drug repositioning hypotheses related calcium channel blockers (ATC code C08). The symbol " refers to the value of the previous cell.\relax }}{163}{table.caption.70}}
\@writefile{lot}{\contentsline {table}{\numberline {4.6}{\ignorespaces Drug repositioning hypotheses related \emph  {Beat-blocking agents} (ATC code C07). The symbol " refers to the value of the previous cell.\relax }}{165}{table.caption.72}}
\@writefile{lot}{\contentsline {table}{\numberline {4.7}{\ignorespaces Actions and number of drugs classified as \emph  {Pro-alpha2-adrenergic receptor activity agent} (FTC\_P0004938).\relax }}{167}{table.caption.74}}
\@writefile{lot}{\contentsline {table}{\numberline {4.8}{\ignorespaces Drug repositioning hypotheses related to \emph  {Diuretics} (ATC code C03). The symbol " refers to the value of the previous cell.\relax }}{168}{table.caption.75}}
\@writefile{lot}{\contentsline {table}{\numberline {4.9}{\ignorespaces Drug repositioning hypotheses related to \emph  {peripheral vasodilators} (ATC code C04). The symbol " refers to the value of the previous cell.\relax }}{173}{table.caption.78}}
\@writefile{toc}{\contentsline {chapter}{Bibliography}{209}{chapter*.83}}
...
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Aldosterone receptor antagonists}\\}{172}{figure.caption.77}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Angiotensin II receptor antagonists}\\}{171}{figure.caption.77}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Angiotensin-converting enzyme (ACE) inhibitors}\\}{170}{figure.caption.77}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Assertional axioms (ABox)}\\}{72}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Classes or concepts}\\}{71}{subsubsection.2.3.3.1}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Existential Restriction ($ \exists $)}\\}{76}{figure.caption.27}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Intersection ($ \sqcap $)}\\}{75}{figure.caption.27}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Named Individuals}\\}{70}{subsubsection.2.3.3.1}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Relational axioms (RBox)}\\}{74}{figure.caption.26}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Renin inhibitors}\\}{171}{figure.caption.77}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Role composition ($ \circ $)}\\}{77}{figure.caption.28}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Roles}\\}{71}{figure.caption.25}}
\@writefile{toc}{\contentsline {paragraph}{\textbf  {Terminological axioms (TBox)}\\}{73}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {paragraph}{biological process}{111}{subsubsection.3.2.9.1}}
\@writefile{toc}{\contentsline {paragraph}{has-function}{114}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{has-part}{113}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{involved-in}{114}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{molecular function}{111}{subsubsection.3.2.9.1}}
\@writefile{toc}{\contentsline {paragraph}{negatively-perturbs}{115}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{negatively-regulates}{113}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{part-of}{112}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{perturbs}{114}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{positively-regulates}{113}{subsubsection.3.2.9.2}}
\@writefile{toc}{\contentsline {paragraph}{postively-perturbs}{115}{subsubsection.3.2.9.2}}
...
\@writefile{toc}{\contentsline {section}{\numberline {3.1}Introduction}{94}{section.3.1}}
\@writefile{toc}{\contentsline {section}{\numberline {3.2}Method and definitions}{97}{section.3.2}}
\@writefile{toc}{\contentsline {section}{\numberline {3.3}The classification}{115}{section.3.3}}
\@writefile{toc}{\contentsline {section}{\numberline {3.4}Evaluation}{118}{section.3.4}}
\@writefile{toc}{\contentsline {section}{\numberline {3.5}Exploration}{119}{section.3.5}}
\@writefile{toc}{\contentsline {section}{\numberline {3.6}Discussion}{126}{section.3.6}}
\@writefile{toc}{\contentsline {section}{\numberline {3.7}Summary}{129}{section.3.7}}
...
\@writefile{toc}{\contentsline {subparagraph}{Concept assertion\\}{73}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {subparagraph}{Concept equivalence ($ \equiv $)\\}{74}{figure.caption.26}}
\@writefile{toc}{\contentsline {subparagraph}{Concept inclusion ($ \sqsubseteq $)\\}{73}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {subparagraph}{Role assertion\\}{73}{subsubsection.2.3.3.2}}
\@writefile{toc}{\contentsline {subparagraph}{Role inclusion ($ \sqsubseteq $)\\}{74}{figure.caption.26}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {1.3.1}Chemical structure-based approaches}{26}{subsection.1.3.1}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {2.2.1}Contemporary formalism in biomedical sciences}{55}{subsection.2.2.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {2.2.2}Requirements for biomedical knowledge formalisation}{61}{subsection.2.2.2}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {2.3.5}The Web Ontology Language 2 (OWL2)}{80}{subsection.2.3.5}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.1}Source code}{97}{subsection.3.2.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.2}Categories creation}{98}{subsection.3.2.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.3}Equivalent definitions}{99}{subsection.3.2.3}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.4}Data integration}{103}{subsection.3.2.4}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.5}Knowledge base classification}{106}{subsection.3.2.5}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.6}Evaluation methodology}{107}{subsection.3.2.6}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.7}Semantic similarity}{110}{subsection.3.2.7}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.8}Mode of action similarity against indication}{110}{subsection.3.2.8}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.2.9}Knowledge base specification}{111}{subsection.3.2.9}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.5.1}Polypharmacology spectrum}{119}{subsection.3.5.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.5.2}Drugs with similar functions have similar indications}{121}{subsection.3.5.2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.6.1}Biological assumptions}{127}{subsection.3.6.1}}
\@writefile{toc}{\contentsline {subsection}{\numberline {3.6.2}Interpreting the evaluation}{128}{subsection.3.6.2}}
...
\@writefile{toc}{\contentsline {subsubsection}{\numberline {1.4.2.3}Chapter 4 - Systematic drug repositioning analysis}{51}{subsubsection.1.4.2.3}}
...
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.2}Definitions}{62}{subsubsection.2.2.2.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.3}Hierarchies and abstraction}{62}{subsubsection.2.2.2.3}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {2.2.2.4}Distributed and scalable}{63}{subsubsection.2.2.2.4}}
...
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.2.1}Mode of Action categories}{98}{subsubsection.3.2.2.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.2.2}Mechanism of Action categories}{99}{subsubsection.3.2.2.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.3.1}Regulatory pattern}{99}{subsubsection.3.2.3.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.3.2}Functional pattern}{102}{subsubsection.3.2.3.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.4.1}Drugbank}{103}{subsubsection.3.2.4.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.4.2}Gene Ontology Annotations (GOA)}{106}{subsubsection.3.2.4.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.6.1}Evaluation Points}{108}{subsubsection.3.2.6.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.6.2}True Positives}{109}{subsubsection.3.2.6.2}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.6.3}False Negatives}{109}{subsubsection.3.2.6.3}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.6.4}False Positives}{109}{subsubsection.3.2.6.4}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.6.5}Precision}{109}{subsubsection.3.2.6.5}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.6.6}Recall}{109}{subsubsection.3.2.6.6}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.9.1}Core FTC classes}{111}{subsubsection.3.2.9.1}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {3.2.9.2}Core FTC properties}{112}{subsubsection.3.2.9.2}}
...
\citation{de2010binding}
\citation{de2010binding}
\citation{delacourte1986alzheimer}
...
\citation{gruber2009encyclopedia}
\citation{grundke1986abnormal}
\citation{hanage2013fuzzy}
\citation{hanage2013fuzzy}
\citation{hane1993pearson}
\citation{hartwell1999molecular}
\citation{hastings2013chebi}
...
\citation{hoshino2011regulation}
\citation{hunskaar1987formalin}
\citation{hunskaar1987formalin}
\citation{hurle2013computational}
\citation{hurle2013computational}
\citation{hurle2013computational}
\citation{hypertensionnhs}
\citation{ikeda2009androgen}
...
\citation{keiser2009predicting}
\citation{keiser2009predicting}
\citation{khalifa2003zuclopenthixol}
\citation{khalifa2003zuclopenthixol}
\citation{kilgore2010inhibitors}
...
\citation{shannon2003cytoscape}
\citation{sirota2011discovery}
\citation{sirota2011discovery}
\citation{stafford2008regulating}
...
\citation{suthram2010network}
\citation{swedberg2005task}
\citation{swedberg2005task}
\citation{swedberg2005task}
\citation{swedberg2005task}
\citation{swinney2011were}
\citation{swinney2011were}
\citation{tanimoto1958elementary}
...
\citation{wolozin2004cholesterol}
\citation{world2006anatomical}
\citation{world2006anatomical}
\citation{world2006anatomical}
\citation{world2006anatomical}
\citation{yang2011systematic}
\citation{young2011more}
\citation{zahler2007inverse}
\citation{zahler2007inverse}
\citation{zdobnov2001interproscan}
\fi}
\fi}
...
\newlabel{sec:opp}
\newlabel{specskb}
\newlabel{tab:tablec07}
\newlabel{tab:tablec08}
\newlabel{tab:tablel02}
\newlabel{table1}
\newlabel{table2}
\newlabel{table:alz}
\newlabel{table:tablealpha}
\newlabel{table:tablec03}
\newlabel{table:tablec04}
