...
\@writefile{lof}{\contentsline {figure}{\numberline {2.3}{\ignorespaces Blackbox model. (A) Schematic representation of a black box. Given an input, an observable output is produced. The internal workings are supposedly not understood. (B) Cells or organism are black boxes: they can carry various and observable functions from an input, yet the internal workings are not necessarily fully understood.\relax }}{58}{figure.caption.20}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {4.15}{\ignorespaces Drug repositioning hypotheses related to the ATC category C02 – \emph  {Anti-hypertensives}. The width of gray edges is proportional to the functional similarity values between drugs. Legend for colors and drug name are available online and in Table \ref  {tab:tablel02}.\relax }}{161}{figure.caption.68}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {4.17}{\ignorespaces Drug repositioning hypotheses related to the ATC category C08 - \emph  {Calcium channel blockers}. The width of gray edges is proportional to the functional similarity values between drugs. The black lines represent the structural similarities. Legend for colors and drug name are available online and on the Table \ref  {tab:tablec08}.\relax }}{164}{figure.caption.71}}
\@writefile{lof}{\contentsline {figure}{\numberline {4.18}{\ignorespaces Drug repositioning hypotheses related to the ATC category C07 - \emph  {Beta blocking agents}. The width of gray edges is proportional to the functional similarity values between drugs. The black lines represent the structural similarities. Legend for colors and drug name are available online and on the Table \ref  {tab:tablec07}.\relax }}{166}{figure.caption.73}}
\@writefile{lof}{\contentsline {figure}{\numberline {4.19}{\ignorespaces Drug repositioning hypotheses related to the ATC category C03 - \emph  {Diuretics}. The width of gray edges is proportional to the functional similarity values between drugs. The black lines represent the structural similarities. Legend for colors and drug name are available online and on the Table \ref  {table:tablec03}.\relax }}{169}{figure.caption.76}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {4.20}{\ignorespaces Simplified summary of the renin-angiotensin system and its implication in blood pressure regulation. Therapeutic intervention points are indicated with a letter. (A) Renin inhibitors: preventing the synthesis of renin reduces the blood pressure. (B) Angiotensin-converting enzyme (ACE) inhibitors: inhibiting the enzymatic activity prevents the synthesis of angiotensin II and decreases the blood pressure. (C) Angiotensin II receptor agonists: blocks the action of the angiotensin II and reduces blood pressure. (D) Aldosterone receptor antagonists: aldosterone signaling promotes water and salt retention and increases the blood pressure. Preventing its action help to release hypertension.\relax }}{170}{figure.caption.77}}
\@writefile{lof}{\contentsline {figure}{\numberline {4.21}{\ignorespaces Drug repositioning hypotheses related to the ATC category C04 - \emph  {Peripheral vasodilators}. The width of gray edges is proportional to the functional similarity values between drugs. The black lines represent the structural similarities. Legend for colors and drug name are available online and on the Table \ref  {table:tablec04}.\relax }}{174}{figure.caption.79}}
\@writefile{lof}{\contentsline {figure}{\numberline {4.22}{\ignorespaces Screenshot of the web application to explore drug repositioning hypotheses. The hypotheses are accessible online at \url  {https://www.ebi.ac.uk/chembl/research/ftc-hypotheses}\relax }}{182}{figure.caption.81}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {5.1}{\ignorespaces Timeline of the drug discovery process. My thesis work focused on the Discovery/Synthesis section of the graph.\relax }}{187}{figure.caption.82}}
